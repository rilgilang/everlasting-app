...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <UCard class="shadow-sm mb-8">
          <div class="flex items-center justify-between">
            ...
            <div class="text-right">
              ...
              <p class="font-semibold text-gray-900 dark:text-white">
                {{ event.messages }} / {{ event.max_messages }} messages
              </p>
            </div>
          </div>
        </UCard>
          ...
          <div class="text-center">
            ...
            <div class="flex justify-center mb-2">
              <img
                ...
                class="w-24 h-24 cursor-pointer hover:scale-105 transition-transform"
                v-if="qrCodeUrl"
                @click="copyQrValue"
              />
    ...
    <div class="mt-12 py-6 border-t border-gray-200 dark:border-gray-800">
      <div
        class="max-w-7xl mx-auto px-6 text-center text-sm text-gray-500 dark:text-gray-400"
      >
        <p>
