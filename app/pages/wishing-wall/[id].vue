...
onMounted(() => {
  ...
  // Open SSE stream to receive real-time messages from AMQP consumer
  ...
  >
    ...
    >
      <div class="text-center">
        <div
          class="w-20 h-20 border-4 border-white/20 border-t-white rounded-full animate-spin mx-auto mb-4"
        ></div>
    ...
    >
      <div class="text-center animate-fadeIn">
        <Icon
          ...
          class="w-24 h-24 text-white/30 mx-auto mb-4"
        />
        ...
        <div class="mt-6 flex gap-2 justify-center">
          ...
          <div
            class="w-2 h-2 bg-white/40 rounded-full animate-pulse delay-150"
          ></div>
          <div
            class="w-2 h-2 bg-white/40 rounded-full animate-pulse delay-300"
          ></div>
        </div>
      </div>
    </div>
    ...
    <div v-else class="relative h-full flex items-center justify-center p-8">
        ...
        >
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-8">
            ...
            <div class="flex flex-col justify-center text-center md:text-left">
              <div class="mb-4">
                <h2
                  class="text-3xl md:text-4xl font-bold text-white mb-2 animate-slideInRight"
                >
                  {{ currentMessage?.name }}
                </h2>
                <p
                  class="text-purple-200 text-sm animate-slideInRight delay-100"
                >
              ...
              <div class="relative">
                <Icon
                  name="i-lucide-quote"
                  class="absolute -top-4 -left-4 w-8 h-8 text-white/20"
                />
                <p
      ...
      <div class="absolute bottom-0 left-0 right-0 h-1 bg-white/10">
        <div
          ...
          :style="{
            width: `${((messageStore.currentMessageIndex + 1) / messageCount) * 100}%`,
          }"
        ></div>
      </div>
